...
// Types
// (TypeScript types omitted for JS, but you can add PropTypes or JSDoc if desired)
  ...
  return (
    <div className="flex flex-col h-screen p-6 font-sans text-[#333] bg-white">
      ...
      <div className="platform-grid grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
        <div
          className={`platform-item px-4 py-3 rounded-lg border text-center cursor-pointer transition-all ${
            selectedPlatform === "" ? "bg-blue-500 text-white border-blue-500" : "bg-white border-gray-200 hover:bg-gray-100 hover:border-gray-300"
          }`}
        ...
        {platforms.map((platform) => (
          <div
            key={platform}
            className={`platform-item px-4 py-3 rounded-lg border text-center cursor-pointer transition-all ${
              selectedPlatform === platform ? "bg-blue-500 text-white border-blue-500" : "bg-white border-gray-200 hover:bg-gray-100 hover:border-gray-300"
            }`}
